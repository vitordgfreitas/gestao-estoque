...
# Login desativado para simplicidade
@app.get("/api/itens-sem-autenticacao")
async def listar_itens_sem_login(db_module = Depends(get_db)):
    return await listar_itens(db_module)
