...
export default function CalculadoraNPV({ financiamentoId }) {
  ...
  const loadValorPresente = async () => {
    try {
      ...
      toast.error('Erro ao calcular valor presente')
    } finally {
      setLoading(false)
    }
  }
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2 mb-2">
          <input
            ...
            className="w-4 h-4"
          />
          <label htmlFor="usarCdi" className="text-sm text-dark-300">
